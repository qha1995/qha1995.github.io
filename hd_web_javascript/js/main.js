...
////////////////////////////////////////////
//자바스크립트 vs 제이쿼리 쓰는 법 차이 
//window.addEventListener('DOMContentLoaded', () => {
//document.querySelector('Wrap').style.color = 'red'; 자바스크립트 
//$('.Wrap').css({color:'red'}); 제이쿼리 
////////////////////////////////////////////
//const TBTN = document.querySelector('.top_close_btn').addEventListener('click', function () {

//});

// $('.top_close_btn').on('click', function () { }); 제이쿼리
//document.querySelector('.top_close.btn').addEventListener('click', function () {
