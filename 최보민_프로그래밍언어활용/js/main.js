...
$(function () {
    ...
    $('.video .productArrows i:nth-child(1)').on('click', function () {
        $('.fly').slick('slickPrev')
    });
    $('.video .productArrows i:nth-child(2)').on('click', function () {
        $('.fly').slick('slickNext')
    });
    ...
    $('.news .productArrows i:nth-child(1)').on('click', function () {
        $('.board').slick('slickPrev')
    });
    $('.news .productArrows i:nth-child(2)').on('click', function () {
        $('.board').slick('slickNext')
    });
